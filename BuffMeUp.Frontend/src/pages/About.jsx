...
const About = () => {
    ...
    return (
        <section className="About-page">
            ...
            <section>
                <h2>What is "BuffMeUp"?</h2>
                <p>
                    BuffMeUp is my final project for SoftUni's C# web module.
                    Although it is functional and does what it's intended to do,
                    this web app is more of a way for me to show off what I've
                    learned so far.
                </p>
            </section>
            ...
            <section>
                ...
                <div className="tech-stack">
                    {stack.map((element) => (
                        <Link to={element.url} className="tech-element">
                            <svg
                                style={{
                                ...
                                height="1em"
                                viewBox={`0 0 ${element.icon?.width} 512`}
                            >
                                <path d={element.icon?.path} />
                            </svg>
                            <h2>{element.name}</h2>
                            <h4>{element.purpose}</h4>
                        </Link>
                    ))}
                </div>
            </section>
