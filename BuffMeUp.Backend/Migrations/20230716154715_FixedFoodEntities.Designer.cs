...
namespace BuffMeUp.Backend.Migrations
{
    ...
    [Migration("20230716154715_FixedFoodEntities")]
    partial class FixedFoodEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BuffMeUp.Backend.Data.Models.Auth.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Admin",
                            PasswordHash = "dSvBqZfF6CgrUwZPAVYALg==;AkaKg5ZLkcWQvNNfMD1avbWvGgp1RS00yfpZMvDANmY=",
                            RoleId = 2,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("BuffMeUp.Backend.Data.Models.Workouts.ExerciseTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dd99a911-7651-4f9b-abed-a3439bd388aa"),
                        ...
                        new
                        {
                            Id = new Guid("4f511810-31bf-468a-9e12-13e940170755"),
                        ...
                        new
                        {
                            Id = new Guid("77c4d84c-75d8-4bca-a085-804c4d198558"),
                            Description = "Stand with your mid-foot under the barbell. Bend over and grab the bar with a shoulder-width grip. Bend your knees until your shins touch the bar. Lift your chest up and straighten your lower back.",
                            ExerciseType = 2,
                            IsGlobal = true,
                            Name = "Squat",
                        ...
                        new
                        {
                            Id = new Guid("bd415227-4f70-4a0e-a1bd-45d1cddf77ef"),
                        ...
                        new
                        {
                            Id = new Guid("f6f8ec4a-374c-4633-9085-414d3f727df3"),
                        ...
                        new
                        {
                            Id = new Guid("6edb1ba1-d1f7-4cae-93f2-be974cde3c6d"),
                        ...
                        new
                        {
                            Id = new Guid("c85c92f4-4656-48ae-893c-a0139a1e52a4"),
                        ...
                        new
                        {
                            Id = new Guid("a92c06e1-b086-44b4-a22d-78234de7abd1"),
